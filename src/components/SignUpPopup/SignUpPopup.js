...
function SignUpPopup({isOpen, handleCloseButton, handlesubscriptButton, onSignUp}) {
  ...
  return (
    <PopupWithForm isOpen={isOpen} name="signup" onSubmit={handleSubmit} handleCloseButton={handleCloseButton} title="Регистрация" >
      ...
      <input type="text" id="name-input" name="name" required placeholder="Введите имя" className="popup__input" value = {userName} onChange = {handleChangeUserName}/>
      <span className="popup__input-error" id="name-input-error"></span>
      <span className="popup__error" id="input-error"></span>
      <button type="submit" className="popup__apply-button">Зарегистрироваться</button>
      <p className="popup__subscript">или <button type="button" className="popup__subscript-button" onClick={handlesubscriptButton}>Войти</button></p>
    </PopupWithForm>
  );
}
